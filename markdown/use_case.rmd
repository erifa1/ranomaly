...
htmltools::tagList(list(ggplotly(beta_souche$plot), ggplotly(beta_temps$plot)))
```
...
MetagenomeSeq use zero-inflated log-normal model with cumulative with CSS normalization (Cumulative Sum Scaling).
