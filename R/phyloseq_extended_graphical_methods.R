# Phyloseq to metagenomeseq function fixed (c) phyloseq

phy2MGseq <- function (physeq, ...)
{
...
plot_clust <- function(physeq, dist, method = "ward.D2", color = NULL,
  ...
  pkgndep::check_pkg("scales")
  tipColor = scales::col_factor(palette, levels = levels(color))(color)
