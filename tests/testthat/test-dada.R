test_that("dada & co", {
  temp_file <- tempfile()
    ...
    dada_res = dada2_fun(cutadapt = FALSE, trim_l = 18, trim_r = 22, path = input_dir, outpath = output_dir, plot = FALSE, compress = TRUE, verbose = 1, paired = TRUE, torrent_single = FALSE ,returnval = TRUE, extension = "_R1.fastq.gz")
